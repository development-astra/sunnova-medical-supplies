  ...
  'inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2',
  {
    variants: {
      variant: {
        ...
        info: 'border-transparent bg-blue-100 text-blue-800 dark:bg-blue-950/40 dark:text-blue-400',
        purple: 'border-transparent bg-purple-100 text-purple-800 dark:bg-purple-950/40 dark:text-purple-400',
      },
    },
